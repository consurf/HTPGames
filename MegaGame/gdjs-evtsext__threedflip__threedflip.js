...
gdjs.evtsExt__ThreeDFlip__ThreeDFlip.ThreeDFlip = class ThreeDFlip extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.Resizable !== undefined)
      this._behaviorData.Resizable = behaviorOverriding.Resizable;
    ...
    if (behaviorOverriding.FlippingMethod !== undefined)
      this._behaviorData.FlippingMethod = behaviorOverriding.FlippingMethod;
    if (behaviorOverriding.FrontAnimation !== undefined)
      this._behaviorData.FrontAnimation = behaviorOverriding.FrontAnimation;
    if (behaviorOverriding.BackAnimation !== undefined)
      this._behaviorData.BackAnimation = behaviorOverriding.BackAnimation;
    if (behaviorOverriding.Duration !== undefined)
      this._behaviorData.Duration = behaviorOverriding.Duration;
    if (behaviorOverriding.IsFlipped !== undefined)
      this._behaviorData.IsFlipped = behaviorOverriding.IsFlipped;
    if (behaviorOverriding.Width !== undefined)
      this._behaviorData.Width = behaviorOverriding.Width;
    if (behaviorOverriding.ElapsedTime !== undefined)
      this._behaviorData.ElapsedTime = behaviorOverriding.ElapsedTime;
